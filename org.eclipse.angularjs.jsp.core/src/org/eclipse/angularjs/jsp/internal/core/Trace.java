 ...
 */
package org.eclipse.angularjs.jsp.internal.core;
...
public class Trace {
	...
	public static void trace(byte level, String s, Throwable t) {
		...
		if (level == SEVERE) {
			...
			AngularJSPCorePlugin
					.getDefault()
					.getLog()
					.log(new Status(IStatus.ERROR,
							AngularJSPCorePlugin.PLUGIN_ID, s, t));
			// logged.add(s);
			// }
		}

		if (!AngularJSPCorePlugin.getDefault().isDebugging())
			return;

		StringBuilder sb = new StringBuilder(AngularJSPCorePlugin.PLUGIN_ID);
		sb.append(" ");
