...
%public
%class AngularTokenizer
%implements BlockTokenizer, DOMRegionContext, AngularRegionContext
...
// scriptlet state(s)
%state ST_ANGULAR_EXPRESSION_CONTENT
...
%state ST_ANGULAR_ATTRIBUTE_VALUE
%state ST_XML_ATTRIBUTE_VALUE_SQUOTED
%state ST_XML_ATTRIBUTE_VALUE_DQUOTED

%state ST_ABORT_EMBEDDED

%state ST_ANGULAR_DQUOTED_EL
%state ST_ANGULAR_SQUOTED_EL

%state ST_ANGULAR_VBL
%state ST_ANGULAR_VBL_SQUOTES
%state ST_ANGULAR_VBL_DQUOTES
%state ST_ANGULAR_VBL_SQUOTES_END
%state ST_ANGULAR_VBL_DQUOTES_END

%state ST_ANGULAR_DQUOTED_VBL
%state ST_ANGULAR_SQUOTED_VBL
...
/**
 * ANGULAR and scripting marker allowances
 */
...
<ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE, ST_PI, ST_XML_PI_EQUALS, ST_XML_PI_ATTRIBUTE_NAME, ST_XML_PI_ATTRIBUTE_VALUE, ST_XML_DECLARATION, ST_XML_DOCTYPE_DECLARATION, ST_XML_ELEMENT_DECLARATION, ST_XML_ATTLIST_DECLARATION, ST_XML_DECLARATION_CLOSE, ST_XML_DOCTYPE_ID_PUBLIC, ST_XML_DOCTYPE_ID_SYSTEM, ST_XML_DOCTYPE_EXTERNAL_ID,ST_XML_ATTRIBUTE_VALUE_DQUOTED,ST_XML_ATTRIBUTE_VALUE_SQUOTED,ST_DHTML_ATTRIBUTE_NAME,ST_DHTML_EQUALS,ST_DHTML_ATTRIBUTE_VALUE,ST_DHTML_TAG_CLOSE> {S}* {
	if(Debug.debugTokenizer)
...
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_DECLARATION> {genericTagOpen} {
	if(Debug.debugTokenizer)
...
<ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE> ["] {
...
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE, ST_XML_DECLARATION> {genericEndTagOpen} {
	if(Debug.debugTokenizer)
...
<ST_XML_ATTRIBUTE_VALUE> {AttValue} { /* only allow for non-ANGULAR tags for this does not obey ANGULAR quoting rules */
	if(Debug.debugTokenizer)
...
<ST_ANGULAR_ATTRIBUTE_VALUE> {QuotedAttValue} { /* ANGULAR attribute values have escape semantics */
	if(Debug.debugTokenizer)
...
<ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE> {genericTagClose} {
	if(Debug.debugTokenizer)
...
<ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE> {genericEmptyTagClose} {
        yybegin(YYINITIAL);
	fEmbeddedHint = UNDEFINED;
	if(Debug.debugTokenizer)
...
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE, ST_XML_DECLARATION> {CommentStart} {
	if(Debug.debugTokenizer)
...
<ST_ANGULAR_EXPRESSION_CONTENT> {jspScriptletEnd} {
	if(Debug.debugTokenizer)
...
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_ANGULAR_ATTRIBUTE_VALUE> {genericTagOpen}! {
	fStateStack.push(yystate());
	if(Debug.debugTokenizer)
