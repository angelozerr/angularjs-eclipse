 ...
 */
package org.eclipse.angularjs.php.internal.core;
...
public class Trace {
	...
	public static void trace(byte level, String s, Throwable t) {
		...
		if (level == SEVERE) {
			...
			AngularPHPCorePlugin
					.getDefault()
					.getLog()
					.log(new Status(IStatus.ERROR,
							AngularPHPCorePlugin.PLUGIN_ID, s, t));
			// logged.add(s);
			// }
		}

		if (!AngularPHPCorePlugin.getDefault().isDebugging())
			return;

		StringBuilder sb = new StringBuilder(AngularPHPCorePlugin.PLUGIN_ID);
		sb.append(" ");
